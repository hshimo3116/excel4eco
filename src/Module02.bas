...
Sub Wordへ一括差し込み処理4()
    ...
    fileName = Range("NUMBER").value & Range("申請者名").value & "別記様式4_" & Format(Now, "yyyymmdd_hhmmss") & ".docx"
...
Sub Word置換(wdDoc As Object, searchText As String, replaceText As String)
